...
import { columns } from '../transactions/transaction.type';
    ...
    return (
        <Box m="1.5rem 2.5rem">
            <FlexBetween>
                ...
                <Box>
                    <Button sx={{
                        ...
                        frontSize: "14px", fontWeight: "bold", padding: "10px 20px"
                    }} >
            ...
            <Box mt="20px" display="grid"
                ...
                <StatBox
                    title="Sales Today"
                    value={data && data.todaysStat.totalSales}
                    increase="+21%"
                    description="Since last month"
                    icon={
                        <PointOfSale
